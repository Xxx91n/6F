...
> RECEIPT RCP-3465fa94fd180daa chain=3465fa94fd180daad64207927e456d32 content=9c2940220a1fb473 facts=2 adjudications=6 issued_at=2026-09-17T15:35:04.143Z commit=92764cb14e7178cb2fa39232208c9fd86a899705 tree=unanchored
>
> 骨架 1.2.0（章顺序锁定，ADR-0006）· 裁定协议 ADR-0013-C/v1 · 生成于 2026-09-17T15:35:04.143Z
>
...
- generated_at: 2026-09-17T15:35:04.143Z
- correlation_key: trace_id=978c1a97853bfa14f9827b854b92c90f baggage_id=b48f14d63db2bca095fcb730d4d4d666
...
- verdict_gate: ADR-0013-C/v1 / insufficient / evidence_flag=false / decided_at=2026-09-17T15:35:04.143Z / audit_ref=reports/48-micro-a-preview.mjs
...
- overall: insufficient · decided_at: 2026-09-17T15:35:04.143Z
- PC-1: supported | basis=B1 | facts=6f210e9b-490e-b0c9-8552-4a38f6b45d86 | evidence=EV-48-ENVMANAGER-PR51-01 | 适配器 run 事实在案：prs_listed=62 calls=4 strategy=env-token（枚举真实发生）
- TC-1: insufficient | basis=B2 | facts=18c52dff-a887-36b2-2950-001446f89df8,1cb9ceba-2555-0c6a-7ded-4098355fedac | evidence=EV-48-ENVMANAGER-PR51-03 | 证据三联缺腿：summary=1 metadata=1 diff=0 merged=true
- TC-2: insufficient | basis=B2 | facts=(none) | evidence=EV-48-ENVMANAGER-PR51-02 | diff 事实缺席
- TC-3: supported | basis=B2 | facts=18c52dff-a887-36b2-2950-001446f89df8 | evidence=EV-48-ENVMANAGER-PR51-03 | 作者形态披露齐备：bot_declared=false basis=platform-declared:user.type==Bot&&login~[bot]
...
- NC-1: supported | basis=B4 | facts=18c52dff-a887-36b2-2950-001446f89df8 | evidence=EV-48-ENVMANAGER-PR51-03 | 负对照：入选实例 human 票面写死；实测 form=human merged=true（closed-unmerged 不入集、形态错配即判负）
...
- grounded: true · collected_at: 2026-09-17T15:35:04.143Z
...
- grounded: false · collected_at: 2026-09-17T15:35:04.143Z
- reproduce_cmd: node .scratch/architecture-recovery/reports/48-micro-a-preview.mjs --golden
- 引文原文: （缺失 —— ⚠ unverified）
...
#### 引文→结论支持关系校验
- CL-48-ENVMANAGER-PR51-01 -> EV-48-ENVMANAGER-PR51-01: supports（matched=prs_listed missing=）全部支撑锚在引文原文中逐字命中（语境剥离后 presence-level 成立——非语义蕴含）
...
- CL-48-ENVMANAGER-PR51-03 -> EV-48-ENVMANAGER-PR51-03: supports（matched=github_rest.pr_metadata missing=）全部支撑锚在引文原文中逐字命中（语境剥离后 presence-level 成立——非语义蕴含）
- CL-48-ENVMANAGER-PR51-04 -> EV-48-ENVMANAGER-PR51-04: supports（matched=D-049 missing=）全部支撑锚在引文原文中逐字命中（语境剥离后 presence-level 成立——非语义蕴含）
- CL-48-ENVMANAGER-PR51-05 -> EV-48-ENVMANAGER-PR51-05: supports（matched=TC-4 missing=）全部支撑锚在引文原文中逐字命中（语境剥离后 presence-level 成立——非语义蕴含）
