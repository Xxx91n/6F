...
> RECEIPT RCP-3364ab7fe117f1a5 chain=3364ab7fe117f1a55c7f40075af459ae content=65c1a3bb6c3a467f facts=2 adjudications=6 issued_at=2026-09-17T02:48:51.199Z commit=92764cb14e7178cb2fa39232208c9fd86a899705 tree=unanchored
>
...
- overall: insufficient · decided_at: 2026-09-17T02:48:51.199Z
- PC-1: supported | basis=B1 | facts=af52e7ed-87ba-2a98-89b5-53de71df8d59 | evidence=EV-48-ENVMANAGER-PR51-01 | 适配器 run 事实在案：prs_listed=62 calls=4 strategy=env-token（枚举真实发生）
- TC-1: insufficient | basis=B2 | facts=f55eb721-b7dd-30e8-4227-0985720ca5db,27c017d8-a346-35b8-3b68-0cb64602bdfd | evidence=EV-48-ENVMANAGER-PR51-03 | 证据三联缺腿：summary=1 metadata=1 diff=0 merged=true
- TC-2: insufficient | basis=B2 | facts=(none) | evidence=EV-48-ENVMANAGER-PR51-02 | diff 事实缺席
- TC-3: supported | basis=B2 | facts=f55eb721-b7dd-30e8-4227-0985720ca5db | evidence=EV-48-ENVMANAGER-PR51-03 | 作者形态披露齐备：bot_declared=false basis=platform-declared:user.type==Bot&&login~[bot]
...
- NC-1: supported | basis=B4 | facts=f55eb721-b7dd-30e8-4227-0985720ca5db | evidence=EV-48-ENVMANAGER-PR51-03 | 负对照：入选实例 human 票面写死；实测 form=human merged=true（closed-unmerged 不入集、形态错配即判负）
...
- grounded: false · collected_at: 2026-09-17T02:48:51.199Z
- reproduce_cmd: node .scratch/architecture-recovery/reports/48-micro-a-preview.mjs --golden
- 引文原文: （缺失 —— ⚠ unverified）
