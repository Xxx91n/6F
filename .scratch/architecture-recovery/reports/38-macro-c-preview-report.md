# MA-38-ANYSEARCH-MACRO-C-PREVIEW — Macro-C 首报（anysearch-cli@8314a3c92b4c）
> RECEIPT RCP-5f869c282a475240 chain=5f869c282a4752402f823cd046975fc2 content=c8d3e80624d8c5c1 facts=1012 adjudications=6 issued_at=2026-09-16T03:03:27+08:00 commit=8314a3c92b4c6f15332e08f3d225cf96675241e3 tree=9a94be447b55
>
...
- PC-MC-1: supported | basis=管线活性正对照 | facts=31d4dba5-11fe-7acf-0085-343152de349b,c92be525-63fc-5a20-9b83-e203b646b086,31c44372-153b-720e-9abe-2427494fb2b1,fd05f3e1-9613-8f6d-2a89-7c584f0eefb6 | evidence=EV-38-05 | codelore pin 0.28.0 + 30/30 facet_rows + ADR 语料 65 份解析
- PC-MC-2: supported | basis=管线活性正对照 | facts=e8c0be39-6fc0-21d9-6a4d-b2f059c1a4c1 | evidence=EV-38-08 | gitlog 族产出 ADR 首提交/lag 事实（first_commit ≥ 63）
- TC-MC-1: supported | basis=演化链完整性 | facts=683492b9-bfb0-f1ff-e937-2f9043458c91 | evidence=EV-38-01,EV-38-02,EV-38-03,EV-38-09 | supersede 引用网 8 边：断链 0 / 缺回链 0（与 37-pilot 存档复测一致=true）
- TC-MC-2: supported | basis=时间维信号可判定性 | facts=e8c0be39-6fc0-21d9-6a4d-b2f059c1a4c1,be74b549-a6a9-714a-6a38-77e20f33bcb8,b16e36d6-ead1-45df-133a-2d349ddf6c3e,43cf3934-4d57-3f37-c05d-7f70a2a540fa,0e6fbe87-a718-616c-e6a5-17d55b1d71f8 | evidence=EV-38-08 | ADR 决策日 vs 首提交 lag 可判定数 65 / 门槛 30（v2 回退链日期解析 65/65）
- TC-MC-3: insufficient | basis=S4 假设失效检测深检 | facts=cdd725b0-9e8e-698c-3a41-3894d27038cc | evidence=EV-38-04 | S4 假设失效检测面 llm_gated（CODELORE_LLM_* env 门控关）→ 深检维度 ⚠ unverified 降级，不伪造不真调
- NC-MC-1: supported | basis=负对照特异性 | facts=d4804083-864e-a817-33cf-fcd09b0b2269 | evidence=EV-38-05 | 负对照选材 apps/cli/package.json 五件套 0 命中（特异性成立）
...
#### 引文→结论支持关系校验
- CL-38-01 -> EV-38-01: supports（matched=edge_count|8 missing=）全部支撑锚在引文原文中逐字命中
- CL-38-02 -> EV-38-02: supports（matched=Superseded by ADR-0060 missing=）全部支撑锚在引文原文中逐字命中
- CL-38-03 -> EV-38-03: supports（matched=ADR-0058 missing=）全部支撑锚在引文原文中逐字命中
- CL-38-04 -> EV-38-04: supports（matched=configured|false missing=）全部支撑锚在引文原文中逐字命中
- CL-38-05 -> EV-38-05: supports（matched=facet_rows|30 missing=）全部支撑锚在引文原文中逐字命中
- CL-38-06 -> EV-38-06: supports（matched=单仓校准（anysearch-cli） missing=）全部支撑锚在引文原文中逐字命中
- CL-38-07 -> EV-38-07: supports（matched=macro_b_facts missing=）全部支撑锚在引文原文中逐字命中
- CL-38-08 -> EV-38-08: supports（matched=lag_judgeable_n missing=）全部支撑锚在引文原文中逐字命中
- CL-38-09 -> EV-38-09: supports（matched=edge_count|8 missing=）全部支撑锚在引文原文中逐字命中
