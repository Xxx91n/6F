...
> RECEIPT RCP-b17d889c7191de37 chain=b17d889c7191de37d03f677c628ea7a6 content=6f86ad9a384cda71 facts=3 adjudications=2 issued_at=2026-09-16T22:42:33.409Z commit=df3d693387a9a5ed429ca28cb9f2e14a625d5859 tree=unanchored
>
...
> - structural_limitations: 拒绝语义：intake 阶段显式拒绝（D-033 硬约束逆用）——报告落 unsupported: 无托管 PR 面＋原因＋前置条件；票面前提漂移如实登记：anysearch-cli 票面撰写时无托管面（#37 实测 github_pr_total=0），本票复核托管枚举 merged=6——前提已漂移，failure 演示主体改取真负例 goose-duck-agent（merged=0）
...
- correlation_key: trace_id=eec7a9e7fea1f1ee950f1d58363a44a1 baggage_id=6f7e5a0d159b898a2ce46ccd52c413d3
...
- overall: unsupported · decided_at: 2026-09-16T22:42:33.409Z
- PC-1: supported | basis=B1 | facts=461cc5f2-f316-515d-b22e-4b0ac578fd35 | evidence=EV-48-GOOSEDUCKAGENT-REF-01 | 适配器 run 事实在案：calls=1 strategy=gh-token（枚举真实发生——拒绝非管线故障）
...
### EV-48-GOOSEDUCKAGENT-REF-01 — 48-micro-a-gate-probes.json @ L17
- claim: 本次实测：goose-duck-agent 托管枚举 merged PR=0——无托管 PR 面
- grounded: true · collected_at: 2026-09-16T22:42:33.409Z
- reproduce_cmd: node .scratch/architecture-recovery/reports/48-micro-a-preview.mjs
- 引文原文: "name": "goose-duck-agent",

### EV-48-GOOSEDUCKAGENT-REF-02 — 48-micro-a-gate-probes.json @ L7
- claim: 前提漂移锚：anysearch-cli 票面撰写时无托管面（#37 实测 pr=0），本票复核托管枚举 merged=6
- grounded: true · collected_at: 2026-09-16T22:42:33.409Z
- reproduce_cmd: node .scratch/architecture-recovery/reports/48-micro-a-preview.mjs
- 引文原文: "name": "anysearch-cli",

### EV-48-GOOSEDUCKAGENT-REF-03 — .scratch/macro-audit/decision-ledger.md @ L44
...
#### 引文→结论支持关系校验
- CL-48-GOOSEDUCKAGENT-REF-01 -> EV-48-GOOSEDUCKAGENT-REF-01: supports（matched=goose-duck-agent missing=）全部支撑锚在引文原文中逐字命中
- CL-48-GOOSEDUCKAGENT-REF-02 -> EV-48-GOOSEDUCKAGENT-REF-02: supports（matched=anysearch-cli missing=）全部支撑锚在引文原文中逐字命中
- CL-48-GOOSEDUCKAGENT-REF-03 -> EV-48-GOOSEDUCKAGENT-REF-03: supports（matched=无托管 PR 面 missing=）全部支撑锚在引文原文中逐字命中
