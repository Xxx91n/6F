...
> RECEIPT RCP-9fe227efa42945d8 chain=9fe227efa42945d80dc6507b533db4ea content=526eb98fec3fb046 facts=3 adjudications=6 issued_at=2026-09-16T22:42:33.409Z commit=f5423020e02a0369730c360b8238a234730be85c tree=838d1f64f051
>
...
- confidence: 0.6
- headline: Xxx91n/env-manager#64 Micro-A preview（capability 3 of 5）：form=machine-generated/release-please diff_channel=local-git +11/-1 f=2 → supported
- degraded_mode: false
...
- PC-1: supported | basis=B1 | facts=970e5b72-284f-148a-b7cc-a32fb54d2b3e | evidence=EV-48-ENVMANAGER-PR64-01 | 适配器 run 事实在案：prs_listed=62 calls=5 strategy=gh-token（枚举真实发生）
- TC-1: supported | basis=B2 | facts=4d831e33-6fad-3fbd-ae17-3d4a1bbb5c16,2f262618-3a4e-dda7-ae83-d4af52a222ad,e3074836-068c-f6c6-f12a-f89d1b95efea | evidence=EV-48-ENVMANAGER-PR64-03 | PR 证据三联齐备（summary＋metadata＋diff）且 merged=true
- TC-2: supported | basis=B2 | facts=e3074836-068c-f6c6-f12a-f89d1b95efea | evidence=EV-48-ENVMANAGER-PR64-02 | diff channel=local-git files=2 +11/-1 bytes=1553
- TC-3: supported | basis=B2 | facts=4d831e33-6fad-3fbd-ae17-3d4a1bbb5c16 | evidence=EV-48-ENVMANAGER-PR64-03 | 作者形态披露齐备：bot_declared=true basis=platform-declared:user.type==Bot&&login~[bot]
...
- NC-1: supported | basis=B4 | facts=4d831e33-6fad-3fbd-ae17-3d4a1bbb5c16 | evidence=EV-48-ENVMANAGER-PR64-03 | 负对照：入选实例 machine-generated/release-please 票面写死；实测 form=machine-generated/release-please merged=true（closed-unmerged 不入集、形态错配即判负）
- human_adjudication: pending（裁定仍由人做，见 B5）

## C3 证据

### EV-48-ENVMANAGER-PR64-01 — 48-micro-a-env-manager-measurements.json @ L9
