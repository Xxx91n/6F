...
export const FILE_LINEAGE_DESCRIPTOR = {
    id: FILE_LINEAGE_ID,
...
export function gitRenameLogArgs(threshold) {
...
export function parseRenameLogZ(raw) {
    const edges = [];
...
export function collectFileLineage(input, ctx) {
    const out = [];
    const seen = new Set();
    let skipped = 0;
